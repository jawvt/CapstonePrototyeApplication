...
ui <- fluidPage(
  ...
  # Custom CSS + Canvas animation script
  tags$head(
    tags$style(HTML("
      /* Global styles */
      body {
      ...
      /* ── NAVBAR: title stacked above tabs, both centered ── */
      .navbar {
      ...
      /* Make the flex container stack vertically and center-align */
      .navbar > .container,
      ...
      /* Collapse wrapper - prevent stretching */
      .navbar-collapse {
        display: flex !important;
      ...
      /* The tab list itself - force horizontal row */
      .navbar-nav,
      ...
      /* Hide Bootstrap's toggler button */
      .navbar-toggle,
      .navbar-toggler {
  ...
  # High-quality canvas animation using sine-wave driven blobs
  tags$script(HTML("
    (function() {
      function initCanvas() {
        ...
        // Each blob: base position (0-1), radius, RGBA colour, movement speed & phase offset
        var blobs = [
        ...
        function draw() {
          ...
          // Soft sky-to-white gradient base
          ...
          blobs.forEach(function(b) {
            // Organic drift via two overlapping sine waves per axis
            ...
            var r = b.r + Math.sin(t * b.sp * 400 + b.ph) * 25;
  ...
  # Tabbed navigation with integrated title
  navbarPage(
    title = div(
      style = "font-family:'Playfair Display',serif; font-size:36px; font-weight:700; letter-spacing:1px; text-shadow:2px 2px 4px rgba(0,0,0,0.3); color:white;",
